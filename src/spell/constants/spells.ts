...
export const SPELLS: Record<Spell, SpellDataType> = {
    ...
    [SPELL.METEOR_SHOWER]: {
        ...
        cost: 30,
        description:
            'Нанести 20 магического урона соседям вражеского артефакта',
        countAnyTarget: 0,
        countTargetEnemy: 1,
        countTargetAllies: 0,
        restrictions: [],
    ...
    [SPELL.FURY]: {
        ...
        cost: 25,
        description:
            'Заставить союзный артефакт атаковать случайную доступную цель',
        countAnyTarget: 0,
        countTargetEnemy: 0,
        countTargetAllies: 1,
        restrictions: [],
    ...
    [SPELL.THUNDER_STORM]: {
        ...
        cost: 35,
        description:
            'Нанести четырем случайным вражеским артефактам 10 магического урона',
        countAnyTarget: 0,
        countTargetEnemy: 0,
        countTargetAllies: 0,
        restrictions: [],
    ...
    [SPELL.BETRAYAL]: {
        ...
        cost: 30,
        description:
            'Заставить вражеский артефакт атаковать свой случайный соседний артефакт',
        countAnyTarget: 0,
        countTargetEnemy: 1,
        countTargetAllies: 0,
        restrictions: [],
    ...
    [SPELL.VAMPIRISM]: {
        ...
        cost: 30,
        description:
            'Наложить на союзный артефакт эффект вампиризма на один удар',
        countAnyTarget: 0,
        countTargetEnemy: 0,
        countTargetAllies: 1,
        restrictions: [],
