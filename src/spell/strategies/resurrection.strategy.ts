...
@Injectable()
export class ResurrectionStrategy implements SpellStrategy {
    constructor(
    ...
    execute(gameState: GameForLogic, player: Player, data: UseSpellData, animations: AnimationData[], logParts: string[]) {
        ...
        this.artifactStateService.applyState(allyArtifact, ARTIFACT_STATE.COOLDOWN, logParts);
        allyArtifact.currentHp = 15;
