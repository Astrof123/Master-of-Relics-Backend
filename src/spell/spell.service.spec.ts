...
describe('SpellService', () => {
    ...
    beforeEach(async () => {
        ...
        (SpellHelper.getResource as jest.Mock).mockReturnValue(
    ...
    describe('calculateSpellActions', () => {
        ...
        it('should calculate actions for light spells', () => {
            ...
            expect(lightSpell.possibleTargets).toEqual([
                ['target1'],
                ['target2'],
            ]);
        });
        ...
        it('should apply light mana discount to light spells', () => {
            gameEffectsService.countHeroEffect.mockImplementation(
                (player, effect) => {
        ...
        it('should calculate actions for dark spells', () => {
            ...
            expect(darkSpell.possibleTargets).toEqual([
                ['target1'],
                ['target2'],
            ]);
        });
        ...
        it('should calculate actions for destruction spells', () => {
            ...
            const destructionSpell =
                player.spells[SPELLTYPE.DESTRUCTION]['piercing_bolt'];
            expect(destructionSpell.cost).toBeDefined();
            expect(destructionSpell.possibleTargets).toEqual([
                ['target1'],
                ['target2'],
            ]);
        });
    ...
    describe('checkCanUse', () => {
        ...
        it('should return true if all conditions are met', () => {
            ...
            expect(SpellHelper.getResource).toHaveBeenCalledWith(
                SPELLTYPE.DESTRUCTION,
            );
            expect(
                restrictionService.checkGeneralRestrictions,
            ).toHaveBeenCalled();
            expect(
                restrictionService.checkSpellRestrictions,
            ).toHaveBeenCalled();
        });
    ...
    describe('Edge cases', () => {
        ...
        it('should handle not negative cost after discount', () => {
            ...
            const destructionSpell =
                player.spells[SPELLTYPE.DESTRUCTION]['piercing_bolt'];
            expect(destructionSpell.cost).toBe(0);
        });
