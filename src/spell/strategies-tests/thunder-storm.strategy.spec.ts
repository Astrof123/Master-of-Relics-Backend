...
describe('ThunderStormStrategy', () => {
    ...
    const createMockPlayer = (id: string): Player => ({
        ...
        artifacts: {
            ...
            'artifact-3': createMockArtifact(
                'artifact-3',
                ARTIFACT_STATE.READY_TO_USE,
            ),
            'artifact-4': createMockArtifact(
                'artifact-4',
                ARTIFACT_STATE.READY_TO_USE,
            ),
            'artifact-5': createMockArtifact(
                'artifact-5',
    ...
    describe('execute', () => {
        ...
        it('should skip broken or destroyed artifacts', () => {
            ...
            const brokenArtifact = Object.values(
                gameState.enemy.artifacts,
            ).find((a) => a.state === ARTIFACT_STATE.BREAKEN);
