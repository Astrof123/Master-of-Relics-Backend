...
describe('DraftGateway', () => {
    ...
    describe('handlePickArtifact', () => {
        ...
        it('should pick artifact successfully', async () => {
            ...
            await gateway.handlePickArtifact(
                mockSocket,
                pickArtifactData,
                mockCallback,
            );

            expect(draftService.pickArtifact).toHaveBeenCalledWith(
                pickArtifactData,
                userId,
            );
        ...
        it('should handle ARTIFACT_NOT_FOUND error', async () => {
            const error = new DraftException(
                DRAFT_ERROR_CODE.ARTIFACT_NOT_FOUND,
            );
    ...
    describe('handleToggleReadyDraft', () => {
        ...
        it('should toggle ready draft successfully', async () => {
            ...
            await gateway.handleToggleReadyDraft(
                mockSocket,
                gameId,
                mockCallback,
            );

            expect(draftService.toggleReadyDraft).toHaveBeenCalledWith(
                gameId,
                userId,
            );
        ...
        it('should handle NOT_PICKED_ARTIFACT error', async () => {
            const error = new DraftException(
                DRAFT_ERROR_CODE.NOT_PICKED_ARTIFACT,
            );
