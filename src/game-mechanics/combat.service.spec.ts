...
describe('CombatService', () => {
    ...
    describe('applyDamage', () => {
        ...
        it('should wake artifact from DREAM state', () => {
            const dreamArtifact = createMockArtifact(
                'artifact-1',
                'arcane_shield',
                ARTIFACT_STATE.DREAM,
            );
            dreamArtifact.extraData.lastStateBeforeRoot =
        ...
        it('should apply vampirism healing to attacker', () => {
            ...
            gameEffectsService.countEffect.mockImplementation(
                (artifact, effect) => {
                    if (
                        effect === EFFECT.VAMPIRISM &&
                        artifact === attackerArtifact
                    )
                        return 1;
                    return 0;
                },
    ...
    describe('applyHealing', () => {
        ...
        it('should wake artifact from DREAM state', () => {
            ...
            healedArtifact.extraData.lastStateBeforeRoot =
                ARTIFACT_STATE.READY_TO_USE;
    ...
    describe('calculateFaceHeal', () => {
        ...
        it('should calculate heal amount from face', () => {
            const result = service.calculateFaceHeal(
                healedArtifact,
                healerArtifact,
            );
    ...
    describe('calculateFaceDamage', () => {
        ...
        it('should calculate melee damage correctly', () => {
            ...
            const result = service.calculateFaceDamage(
                player,
                enemy,
                attackerArtifact,
                attackedArtifact,
        ...
        it('should apply general damage reduction', () => {
            ...
            gameEffectsService.countEffect.mockImplementation(
                (artifact, effect) => {
                    if (
                        effect === EFFECT.DIVINE_GUARD &&
                        artifact === attackedArtifact
                    )
                        return 2;
                    return 0;
                },
