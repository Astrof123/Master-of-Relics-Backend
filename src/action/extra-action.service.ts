...
export class ExtraActionService {
    ...
    constructor(
        ...
        this.handlers = {
            ...
            [EXTRA_ACTION.RETURN_TO_BATTLE]:
                this.handleReturnToBattle.bind(this),
            ...
            [EXTRA_ACTION.DESTROY_ARTIFACT]:
                this.handleDestroyArtifact.bind(this),
        };
    }
    ...
    getExtraActions(
        ...
        for (const [key, action] of Object.entries(EXTRA_ACTIONS)) {
            ...
            if (
                this.gameEffectsService.countEffect(artifact, EFFECT.GLIMPSE) >
                0
            ) {
            ...
            if (
                player.resources[action.resourceType] >= cost &&
