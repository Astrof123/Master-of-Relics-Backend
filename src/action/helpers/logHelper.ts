...
export class LogHelper {
    public static getHitLog(
        damage: number,
        damageType: DamageType,
        attackedArtifactName: string,
    ) {
        let damageTypeName = '';
    ...
    public static getMoveArtifactLog(
        artifactName: string,
        position: number,
        line: Line,
    ) {
    ...
    public static getSpawnArtifactLog(
        artifactName: string,
        position: number,
        line: Line,
    ) {
    ...
    public static getAppliedStateLog(
        artifactName: string,
        state: ArtifactState,
    ) {
        let stateName = '';
    ...
    public static getAppliedEffectLog(
        effect: EffectType,
        artifactName: string,
    ) {
    ...
    public static getRemoveHeroEffectLog(
        effect: EffectType,
        playerName: string,
    ) {
    ...
    public static getAppliedHeroEffectLog(
        effect: EffectType,
        playerName: string,
    ) {
