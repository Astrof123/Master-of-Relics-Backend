...
export const DRAFT_ERROR_MESSAGE: Record<ACTION_ERROR_CODE, string> = {
    ...
    [ACTION_ERROR_CODE.ARTIFACT_NOT_READY]:
        'Артефакт не в состоянии готовности',
    ...
    [ACTION_ERROR_CODE.NO_ACTIONS_TAKEN]: 'Не сделано ни одного действия',
};
