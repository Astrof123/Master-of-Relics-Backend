export const RESTRICTION = {
    ...
    ENEMY_HAVE_TEN_LIGHT_MANA: 'enemy_have_ten_light_mana',
    ENEMY_HAVE_TEN_DARK_MANA: 'enemy_have_ten_dark_mana',
    ENEMY_HAVE_TEN_DESTRUCTION_MANA: 'enemy_have_ten_destruction_mana',
    ...
    HAVE_ONE_MOVE_POINT: 'have_one_move_point',
};
...
export type TargetRestriction =
    (typeof TARGET_RESTRICTION)[keyof typeof TARGET_RESTRICTION];
