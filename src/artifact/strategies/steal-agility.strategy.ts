...
@Injectable()
export class StealAgilityStrategy implements SkillStrategy {
    constructor(
    ...
    execute(gameState: GameForLogic, player: Player, artifact: ArtifactGameState, data: UseSkillData, animations: AnimationData[], logParts: string[]) {
        ...
        this.resourceService.decreaseResource(enemy, RESOURCE.AGILITY, 10, logParts);
        this.resourceService.addResource(player, RESOURCE.AGILITY, 10, logParts);
    }
