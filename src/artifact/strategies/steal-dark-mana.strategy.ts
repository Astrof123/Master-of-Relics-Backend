...
@Injectable()
export class StealDarkManaStrategy implements SkillStrategy {
    constructor(
    ...
    execute(gameState: GameForLogic, player: Player, artifact: ArtifactGameState, data: UseSkillData, animations: AnimationData[], logParts: string[]) {
        ...
        this.resourceService.decreaseResource(enemy, RESOURCE.DARK_MANA, 10, logParts);
        this.resourceService.addResource(player, RESOURCE.DARK_MANA, 10, logParts);
    }
