...
describe('NeighboringHealingStrategy', () => {
  ...
  const createMockArtifact = (id: string, currentHp: number = 20, maxHp: number = 30): ArtifactGameState => ({
    id,
  ...
  beforeEach(async () => {
    ...
    strategy = module.get<NeighboringHealingStrategy>(NeighboringHealingStrategy);
