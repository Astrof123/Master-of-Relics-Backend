...
jest.mock('../../game-mechanics/constants/effects', () => ({
  EFFECTS: {
    'shiv': { id: 'shiv', name: 'Shiv' },
  },
}));

describe('ShivStrategy', () => {
  let strategy: ShivStrategy;
  ...
  beforeEach(async () => {
    ...
    strategy = module.get<ShivStrategy>(ShivStrategy);
  ...
  describe('getSkillType', () => {
    it('should return SHIV', () => {
      expect(strategy.getSkillType()).toBe(SKILL.SHIV);
    });
  });
  ...
  describe('execute', () => {
    ...
    it('should apply SHIV effect to enemy artifact', () => {
