...
jest.mock('../../game-mechanics/constants/effects', () => ({
  EFFECTS: {
    'light_blight': { id: 'light_blight', name: 'Light Blight' },
  },
}));

describe('LightBlightStrategy', () => {
  let strategy: LightBlightStrategy;
  ...
  beforeEach(async () => {
    ...
    strategy = module.get<LightBlightStrategy>(LightBlightStrategy);
  ...
  describe('getSkillType', () => {
    it('should return LIGHT_BLIGHT', () => {
      expect(strategy.getSkillType()).toBe(SKILL.LIGHT_BLIGHT);
    });
  });
  ...
  describe('execute', () => {
    ...
    it('should apply LIGHT_BLIGHT hero effect to enemy', () => {
