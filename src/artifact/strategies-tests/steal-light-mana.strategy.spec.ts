...
describe('StealLightManaStrategy', () => {
    let strategy: StealLightManaStrategy;
    ...
    beforeEach(async () => {
        ...
        strategy = module.get<StealLightManaStrategy>(StealLightManaStrategy);
    ...
    describe('getSkillType', () => {
        it('should return STEAL_LIGHT_MANA', () => {
            expect(strategy.getSkillType()).toBe(SKILL.STEAL_LIGHT_MANA);
        });
    });
    ...
    describe('execute', () => {
        ...
        beforeEach(() => {
            ...
            data = {
                skillId: SKILL.STEAL_LIGHT_MANA,
                gameId: 'game-123',
        ...
        it('should decrease enemy light mana by 10', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
        ...
        it('should add 10 light mana to player', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
