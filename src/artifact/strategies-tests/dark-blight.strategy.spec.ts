...
jest.mock('../../game-mechanics/constants/effects', () => ({
  EFFECTS: {
    'dark_blight': { id: 'dark_blight', name: 'Dark Blight' },
  },
}));

describe('DarkBlightStrategy', () => {
  let strategy: DarkBlightStrategy;
  ...
  beforeEach(async () => {
    ...
    strategy = module.get<DarkBlightStrategy>(DarkBlightStrategy);
  ...
  describe('getSkillType', () => {
    it('should return DARK_BLIGHT', () => {
      expect(strategy.getSkillType()).toBe(SKILL.DARK_BLIGHT);
    });
  });
  ...
  describe('execute', () => {
    ...
    it('should apply DARK_BLIGHT hero effect to enemy', () => {
