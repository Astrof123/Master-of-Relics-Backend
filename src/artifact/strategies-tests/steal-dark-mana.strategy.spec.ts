...
describe('StealDarkManaStrategy', () => {
    let strategy: StealDarkManaStrategy;
    ...
    beforeEach(async () => {
        ...
        strategy = module.get<StealDarkManaStrategy>(StealDarkManaStrategy);
    ...
    describe('getSkillType', () => {
        it('should return STEAL_DARK_MANA', () => {
            expect(strategy.getSkillType()).toBe(SKILL.STEAL_DARK_MANA);
        });
    });
    ...
    describe('execute', () => {
        ...
        it('should decrease enemy dark mana by 10', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
        ...
        it('should add 10 dark mana to player', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
