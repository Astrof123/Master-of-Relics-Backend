...
describe('StealAgilityStrategy', () => {
    let strategy: StealAgilityStrategy;
    ...
    beforeEach(async () => {
        ...
        strategy = module.get<StealAgilityStrategy>(StealAgilityStrategy);
    ...
    describe('getSkillType', () => {
        it('should return STEAL_AGILITY', () => {
            expect(strategy.getSkillType()).toBe(SKILL.STEAL_AGILITY);
        });
    });
    ...
    describe('execute', () => {
        ...
        it('should decrease enemy agility by 10', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
        ...
        it('should add 10 agility to player', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
