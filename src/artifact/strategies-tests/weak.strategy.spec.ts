...
describe('WeakStrategy', () => {
  let strategy: WeakStrategy;
  ...
  beforeEach(async () => {
    ...
    strategy = module.get<WeakStrategy>(WeakStrategy);
  ...
  describe('getSkillType', () => {
    it('should return WEAK', () => {
      expect(strategy.getSkillType()).toBe(SKILL.WEAK);
    });
  });
  ...
  describe('execute', () => {
    ...
    it('should apply COOLDOWN state to enemy artifact', () => {
