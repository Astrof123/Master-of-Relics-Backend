...
describe('EatDarkManaStrategy', () => {
  let strategy: EatDarkManaStrategy;
  ...
  beforeEach(async () => {
    ...
    strategy = module.get<EatDarkManaStrategy>(EatDarkManaStrategy);
  ...
  describe('getSkillType', () => {
    it('should return EAT_DARK_MANA', () => {
      expect(strategy.getSkillType()).toBe(SKILL.EAT_DARK_MANA);
    });
  });
  ...
  describe('execute', () => {
    ...
    it('should decrease dark mana and heal artifact', () => {
