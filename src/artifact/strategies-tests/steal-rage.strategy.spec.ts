...
describe('StealRageStrategy', () => {
    let strategy: StealRageStrategy;
    ...
    beforeEach(async () => {
        ...
        strategy = module.get<StealRageStrategy>(StealRageStrategy);
    ...
    describe('getSkillType', () => {
        it('should return STEAL_RAGE', () => {
            expect(strategy.getSkillType()).toBe(SKILL.STEAL_RAGE);
        });
    });
    ...
    describe('execute', () => {
        ...
        it('should decrease enemy rage by 10', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
        ...
        it('should add 10 rage to player', () => {
            strategy.execute(
                gameState,
                player,
                artifact,
